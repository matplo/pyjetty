...
parallel --bar --joblog pythia_write_groomed_parallel.log --keep-order --tag ./pythia_write_groomed.py --fj-R 0.4 --npart-min 300 --py-PbPb --py-seed {} --output pythia_out_PbPb_{}.root ::: ${seeds}
