...
parallel --progress --jobs 8 ./eec_flavor_dep_example.py --nev 10000 --py-pthatmin {2} --jet-ptmin {2} --jet-ptmax '$(expr {2} + 50)' --py-hardQCD{1} --output eec_{1}_{2}.root "2>&1 >" eec_{1}_{2}.log ::: gluons uds charm beauty ::: 20 100 500
