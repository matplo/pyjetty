...
embs="--embed /Users/ploskon/data/alice/LHC18qr/local_PbPb_file_list.txt"
parallel --joblog run_cstoy.log --keep-order --tag ./cstoy.py --overwrite --py-pthatmin 80 --nev 10000 --zcut 0.2 --dRmax 0.25 --py-seed {} ${embs} --efficiency ::: 22 33 44 55 66 77 88
