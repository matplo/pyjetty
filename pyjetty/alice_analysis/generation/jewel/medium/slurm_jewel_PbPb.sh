...
OUTDIR=/rstorage/ml/egml/data/jewel_PbPb/$SLURM_ARRAY_JOB_ID/$SLURM_ARRAY_TASK_ID
mkdir -p $OUTDIR
...
mv /rstorage/ml/egml/data/jewel_PbPb/slurm-${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.out /rstorage/ml/egml/data/jewel_PbPb/${SLURM_ARRAY_JOB_ID}/
