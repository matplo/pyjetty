...
# This script takes an input hdf5 file path as an argument, and runs a script to 
# skim and standardize the jets for processing.
...
PREFIX="/rstorage/ml/egml/skim/$JOB_ID"
...
pipenv run python process/user/ml/skim_ppAA_data.py -f $INPUT_FILE -o $OUTPUT_DIR
