...
echo $INPUT_FILE
OUTPUT_SUFFIX=$(echo $INPUT_FILE | cut -d/ -f5-12)
echo $OUTPUT_SUFFIX
...
pipenv run python process/user/james/process_mc_theta_g.py -c config/theta_g/PbPb/james_PbPb_fastsim_jetscape_EP.yaml -f $INPUT_FILE -o $OUTPUT_DIR
