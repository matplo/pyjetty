...
OUTPUT_PREFIX="AnalysisResults/lund/$JOB_ID"
...
python process/user/lund/process_data_lund.py -c config/lund/process_lund.yaml -f $INPUT_FILE -o $OUTPUT_DIR

# Move stdout to appropriate folder
mv /rstorage/alice/AnalysisResults/lund/slurm-${JOB_ID}_${TASK_ID}.out /rstorage/alice/AnalysisResults/lund/${JOB_ID}
