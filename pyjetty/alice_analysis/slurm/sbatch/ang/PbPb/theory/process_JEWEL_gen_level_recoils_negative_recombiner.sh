...
python process/user/ang/process_jewel_truth_level_ang.py -c config/ang/PbPb/theory/JEWEL_yesrecoil_yessubtraction_negative_recombiner.yaml -f $INPUT_FILE -o $OUTPUT_DIR
