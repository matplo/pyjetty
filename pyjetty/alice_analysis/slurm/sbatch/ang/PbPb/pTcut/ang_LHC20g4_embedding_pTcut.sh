...
python process/user/ang/process_mc_ang.py -c config/ang/PbPb/leading_track_pTcut/process_angularity_PbPb_embedding_pTcut.yaml -f $INPUT_FILE -o $OUTPUT_DIR
