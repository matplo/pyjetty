...
OUTPUT_SUFFIX=$(echo $INPUT_FILE | cut -d/ -f8-13)
echo $OUTPUT_SUFFIX
...
python process/user/ang/process_mc_ang.py -c config/ang/PbPb/leading_track_pTcut/process_angularity_PbPb_fastsim_pTcut.yaml -f $INPUT_FILE -o $OUTPUT_DIR
