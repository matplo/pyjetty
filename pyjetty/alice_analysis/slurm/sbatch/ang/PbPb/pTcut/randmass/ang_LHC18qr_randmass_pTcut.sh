...
python process/user/ang/process_data_ang.py -c config/ang/PbPb/leading_track_pTcut/process_angularity_PbPb_randmass_pTcut.yaml -f $INPUT_FILE -o $OUTPUT_DIR
